...
test.describe('@Regression @Smoke - First Test suite',()=>{

    test('Section_02_KO_UI_Tests #1 - Annotations - describe - TAGGING', async ({page} )=> {
    ...
    test('Section_02_KO_UI_Tests #2 - Annotations - describe - TAGGING', async ({page} )=> {
...
test.describe('@Regression @BVT - Second Test suite',()=>{

    test('Section_02_KO_UI_Tests #3 - Annotations - describe - TAGGING', async ({page} )=> {
    ...
    test('Section_02_KO_UI_Tests #4 - Annotations - describe - TAGGING', async ({page} )=> {
