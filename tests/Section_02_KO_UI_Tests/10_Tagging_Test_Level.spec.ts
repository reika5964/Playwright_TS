...
test.describe('Test suite',()=>{
    ...
    test('@Regression @Smoke Section_02_KO_UI_Tests #1 - Annotations - describe - TAGGING', async ({page} )=> {
    ...
    test('@Regression @Sanity Section_02_KO_UI_Tests #2 - Annotations - describe - TAGGING', async ({page} )=> {
    ...
    test('@Regression @BVT Section_02_KO_UI_Tests #3 - Annotations - describe - TAGGING', async ({page} )=> {
    ...
    test('@Regression @Smoke @BVT Section_02_KO_UI_Tests #4 - Annotations - describe - TAGGING', async ({page} )=> {
